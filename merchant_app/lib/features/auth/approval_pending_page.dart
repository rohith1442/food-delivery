...
class _ApprovalPendingPageState extends State<ApprovalPendingPage> {
  ...
  Future<void> _checkStatus() async {
    ...
    try {
      ...
      _showMessage('Your account is still waiting for approval');
    } on DioException catch (error) {
      if (!mounted) return;

      final data = error.response?.data;

      var message = 'Unable to check account status';
      ...
      _showMessage('Unable to check account status');
    } finally {
      if (mounted) {
        setState(() {
          checking = false;
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: checking ? null : _logout,
