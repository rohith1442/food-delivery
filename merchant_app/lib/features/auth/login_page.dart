...
class _MerchantLoginPageState extends State<MerchantLoginPage> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      final role = userData['role']?.toString().trim().toUpperCase();

      final rawStatus = userData['status']?.toString().trim().toUpperCase();
      ...
      if (role != 'MERCHANT') {
        ...
        _showMessage('This account is not registered as a merchant');
      ...
      switch (status) {
        ...
        case 'REJECTED':
          ...
          _showMessage('Your merchant registration was rejected');
          return;
        ...
        case 'SUSPENDED':
          ...
          _showMessage('Your merchant account is suspended');
          return;
        ...
        default:
          ...
          _showMessage('Merchant account is not active');
      }
      ...
      switch (error.code) {
        ...
        case 'user-disabled':
          message = 'This merchant account is disabled';
          break;
      ...
      _showMessage(
        _getApiErrorMessage(error, 'Unable to verify merchant account'),
      );
    } catch (_) {
      if (!mounted) return;
  ...
  String _getApiErrorMessage(DioException error, String fallback) {
