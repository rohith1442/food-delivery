...
class AppBranding {
  ...
  final String deliveryPromiseText;
  ...
  const AppBranding({
    ...
    required this.deliveryPromiseText,
  });
  ...
  factory AppBranding.fromJson(Map<String, dynamic>? json) {
    ...
    return AppBranding(
      appName: _requiredText(json['appName'], fallback.appName),
      shortName: _requiredText(json['shortName'], fallback.shortName),
      tagline: _requiredText(json['tagline'], fallback.tagline),
      ...
      deliveryPromiseText: _requiredText(
        json['deliveryPromiseText'],
        fallback.deliveryPromiseText,
      ),
    );
  }
